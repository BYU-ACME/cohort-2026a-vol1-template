...
LABS=("Conditioning_Stability" "DataVisualization" "Differentiation" "Exceptions_FileIO" "FacialRecognition" "ImageSegmentation" "LeastSquares_Eigenvalues" "LinearTransformations" "PageRank" "Profiling" "SQL1" "SQL2" "SVD_ImageCompression" "UnixShell1" "UnixShell2")
